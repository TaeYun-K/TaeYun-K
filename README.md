...
**효율적 설계를 고민**<br>
“더 나은 방법은 없을까?”를 기준으로 설계를 점검하며,
성능·확장성·유지보수를 고려한 구조 개선을 꾸준히 시도합니다.

**빠른 습득과 책임감**<br>
새로운 기술과 도메인을 빠르게 이해해 실무에 적용하고,
맡은 문제는 끝까지 책임지고 해결합니다.

**유연한 사고와 긍정적인 소통**<br>
고정관념에 얽매이지 않고 다양한 의견을 수용하며,
긍정적인 커뮤니케이션을 통해 팀과 함께 더 나은 결과를 만들어갑니다.
...
| PCCP Lv.4 (코딩전문역량인증) | (주) 그렙 | 2025.12.21 |
...
|---|---|---|---|---|
| <img src="https://raw.githubusercontent.com/TaeYun-K/RUNNERS/refs/heads/main/image%20(4).png" width="200" /> | 2025.12 ~ 현재 | **RUNNERS – 러닝 커뮤니티 모바일 앱**<br/>[GitHub](https://github.com/TaeYun-K/RUNNERS) | Android · Backend · DevOps | Health Connect 연동 <br> 러닝 커뮤니티 <br> [링크](https://runners.io.kr/) |
...
| <img src="https://raw.githubusercontent.com/TaeYun-K/WIT/master/pjt_wit_t11_front/src/assets/homepage.png" width="200" /> | 2025.03 ~ 2025.05 | **WIT – TSP 기반 여행 일정 추천 서비스**<br/>[GitHub](https://github.com/TaeYun-K/WIT) | AI · 여행 · Backend | TSP 기반 일정 최적화<br/>AI 챗봇 맞춤 일정 추천 |
